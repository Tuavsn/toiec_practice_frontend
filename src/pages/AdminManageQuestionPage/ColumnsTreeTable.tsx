...
export function ExpandTypeBodyTemplate(questionNode: TreeNode): JSX.Element {
    type PartColor = "success" | "info" | "warning" | "danger";
    const colors: PartColor[] = ["danger", "success", "info", "warning"];
...
function ConvertContextToSimpleTable(questionContext: QuestionContext): JSX.Element {
    ...
    return (
        <section className='flex flex-wrap gap-3'>  // Bao bọc nội dung trong một section với kiểu layout flex
            {
